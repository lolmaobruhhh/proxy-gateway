...
export function runSandboxCode(code, reqBody, features, provider, requestContext, expressReq, expressRes) {
    ...
    try {
        ...
        cleanCode += '\n__result = __fn(__req, __features, __provider, __context, __expressReq, __expressRes);';
        ...
        // Safe wrapper for Express Request to prevent VM circular reference crashes
        ...
        // Safe wrapper for Express Response
